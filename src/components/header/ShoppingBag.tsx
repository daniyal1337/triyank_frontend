  ...
  return (
    <div className="fixed inset-0 z-50 h-screen">
      ...
      <div className="absolute right-0 top-0 h-screen w-96 border-l border-border animate-slide-in-right flex flex-col" style={{ backgroundColor: panelBackgroundColor }}>
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 p-2 text-[#1a1410] hover:text-[#1a1410]/70 transition-colors"
          aria-label="Close"
        >
          <X size={20} />
        </button>
        ...
        <div className="flex border-b border-[#1a1410]/20 px-6 pt-6 pb-0">
          <button
        ...
        <div className="flex flex-col h-[calc(100vh-60px)] p-6 pt-4">
          ...
          {showWishlist ? (
            ...
            wishlistItems.length === 0 ? (
              ...
              <>
                <div className="flex-1 min-h-0 overflow-y-auto pr-2 scrollbar-visible">
                ...
                <div className="border-t border-[#1a1410]/20 pt-4 mt-6 shrink-0">
                  <Button 
                    variant="outline" 
            ...
            <>
              {cartItems.length === 0 ? (
                ...
                <>
                  ...
                  <div className="border-t border-[#1a1410]/20 pt-6 space-y-4 mt-6 shrink-0">
